    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:500px;margin:0 auto;padding:20px;">
          ...
          <p style="font-size:14px;color:#374151;">This is a reminder for your pending payment.</p>
          ...
          <p style="font-size:12px;color:#9ca3af;text-align:center;">
            Tap the button above on your mobile to pay
          </p>
          <hr style="border:none;border-top:1px solid #e5e7eb;margin:20px 0;">
          <p style="font-size:12px;color:#9ca3af;">If you have already paid, please ignore this message.</p>
          <p style="font-size:13px;color:#374151;">Thank you,<br><strong>${businessName}</strong></p>
        </div>
      `
    });
